...
public class ProjectManagement {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public void assignTeamRole(AssignTeamRoleCommand assignTeamRoleCommand) {
        //implement business logic here:

        TeamMemberRoleAssigned teamMemberRoleAssigned = new TeamMemberRoleAssigned(
            this
        );
        teamMemberRoleAssigned.publishAfterCommit();
    }
    //>>> Clean Arch / Port Method
